 ...
 * Default mode is 1
 */
int32_t SimpleBMP180::getPressure(uint8_t mode) {
 ...
 */
int16_t SimpleBMP180::getLastTemperature(void) {
	return _lastTemp;
}

/*********************************************************************/

void SimpleBMP180::writeCmd(uint8_t cmd) {
...
uint8_t SimpleBMP180::retrieveData(BMP180registers rgstr, int8_t quantity) {
	Wire.beginTransmission(I2CAddr); // start the transmission
